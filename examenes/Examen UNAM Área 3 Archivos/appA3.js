const bd_juego = [
    ...
    {
        id:18,
        pregunta:"Una persona pesa 96 kg. Al ingresar a una clínica reductora de peso, comienza a bajar 1/32 del peso inicial cada semana. ¿Cuántos kg pesará al término de cada una de las primeras cuatro semanas del tratamiento?",
        ...
        op3:"Semana 1: 93, Semana 2: 92, Semana 3: 91, Semana 4: 90",
        correcta:"0"
    },
    {
        id:19,
        pregunta:"Para aprobar un examen de idiomas, un estudiante debe obtener un promedio mínimo de 8 y calificaciones no menores a 7 en cada uno de los parciales. Juan tiene las siguientes calificaciones en los primeros 3 parciales: 7.2, 8.5 y 7.9. ¿Cuál es la mínima calificación que deberá obtener en el cuarto y último parcial para aprobar el curso?",
        op0:"8.1",
        op1:"8.2",
        op2:"8.4",
        op3:"8.9",
    ...
    {
        id:23,
        pregunta:"Calcula x para 5x + 3 ≤ 6x – 8",
        op0:"x ≤ 1",
        op1:"x ≥ 11",
        op2:"x ≥ 1",
        op3:"x ≤ -11",
    ...
    },
    {
        ...
        op3:"Conejos 35, gallinas 26",
        correcta:"2"
    },
    {
        id:25,
        pregunta:"Calcula el dominio de",
        op0:"(∞-,7) ∪ (8,∞)",
        op1:"(-∞,-1) ∪ (-1,∞)",
        op2:"(-∞,1) ∪ (1,∞)",
        op3:"(-∞,-1) ∪ [-1,∞)",
    ...
    {
        id:26,
        pregunta:"El rango de la función cuya gráfica se muestra a continuación, son los valores",
        op0:"Mayores que 0 y menores que 1.",
        op1:"Mayores que 2.",
        op2:"Mayores o iguales que 0.",
        op3:"Menores o iguales que 0.",
        correcta:"2",
        img:"fun.png"
    },
    {
    ...
    {
        id:28,
        pregunta:"¿Cuál de las siguientes gráficas representa una función para x?",
        op0:"",
        op0img:"xy.png",
        op1:"",
        op1img:"abajo.png",
    ...
    {
        id:29,
        pregunta:"Si 2π radianes equivalen a A 360º, ¿a cuánto equivale un ángulo de 7/8π  radianes?",
        op0:"135º",
        op1:"145º 30’",
        op2:"270º",
        op3:"157º 30’",
    ...
    {
        id:31,
        pregunta:"Sea la función y = log(x-2). El domino de la función es:",
        op0:"(2,∞)",
        op1:"[2,∞)",
        op2:"(2,∞]",
        op3:"(x-2,∞)",
    ...
    {
        id:32,
        pregunta:"Sea la función y = log4 (x-2), ¿cuál es la recta que es asíntota a la función?",
        op0:"y = 2",
        op1:"y = 2x",
        op2:"x = 2",
        op3:"x = 0",
    ...
    {
        id:36,
        pregunta:"Ecuación que corresponde a una circunferencia de radio = √2 y centro en (0, 0)",
        op0:"x^2 - y^2 = 2",
        op1:"x^2 + y^2 = √2",
        op2:"x + y = 2",
        op3:"x^2 + y^2 = 2",
    ...
    {
        id:72,
        pregunta:"Recurso que utiliza el historiador para ordenar cronológicamente el estudio del pasado:",
        op0:"Investigación.",
        op1:"Periodización.",
        op2:"Selección.",
        op3:"Observación.",
    ...
    {
        id:73,
        pregunta:"En la doctrina política del absolutismo el",
        op0:"Pueblo es quien determina de manera absoluta su voluntad por medio del voto.",
        op1:"Poder se ejerce de manera compartida entre el monarca y su parlamento.",
        op2:"Ejercicio del poder es detentado en un partido único.",
        op3:"Poder es ejercido por el rey, sin considerar al parlamento.",
        correcta:"3"
    },
    {
        id:74,
    ...
    {
        id:80,
        pregunta:"Al desembarco de armamento en Cuba que incluía proyectiles, cohetes, botes de patrulla y cazas mig, así como técnicos e instructores de la Unión de Repúblicas Socialistas Soviéticas, se le conoció con el nombre de la",
        op0:"Enmienda Platt.",
    ...
    {
        id:82,
        pregunta:"Países asiáticos que se independizaron a mediados del siglo XX.",
        op0:"India e Irán.",
        op1:"Timor y Angola.",
        op2:"Kenia e Irak.",
        op3:"Siria y Líbano.",
    ...
    {
        id:85,
        pregunta:"Fenómeno económico que se manifiesta en una serie de tendencias recientes del desarrollo capitalista que acelera la integración de las economías nacionales:",
        op0:"Neocapitalismo.",
        op1:"Socialismo.",
        op2:"Globalización.",
        op3:"Nacionalismo.",
    ...
    {
        id:86,
        pregunta:"La principal actividad económica de los pueblos de Mesoamérica fue la",
        op0:"Caza y pesca.",
        op1:"Comercio.",
        op2:"Agricultura.",
        op3:"Recolección de frutos.",
        correcta:"2"
    },
    {
        id:87,
    ...
    {
        id:90,
        pregunta:"El gobierno de Benito Juárez se caracterizó por",
        op0:"Perdonar a los enemigos.",
        op1:"Aplicar el liberalismo.",
        op2:"Apegarse a la constitución.",
        op3:"Apoyar a la iglesia católica.",
        correcta:"1"
    },
    {
        id:91,
    ...
    {
        id:96,
        pregunta:"La nacionalización del petróleo por Lázaro Cárdenas",
        op0:"I y III",
        op1:"II y III",
        op2:"III y V",
        op3:"IV y V",
    ...
    {
        id:99,
        pregunta:"La economía de mercado y las privatizaciones entre 1982 y 2000 son parte del",
        op0:"Plan de once años.",
        op1:"Neoliberalismo.",
        op2:"Welfare State.",
        op3:"Plan Sexenal.",
        correcta:"1"
...
function cargarPreguntas(){
    ...
    if(pregunta.hasOwnProperty("op0img")){
        const imglbl = document.createElement("img");
        imglbl.classList.add("img2")
        imglbl.src = pregunta.op0img;
        label1.appendChild(imglbl);
    }
    if(pregunta.hasOwnProperty("op1img")){
        const imglbl = document.createElement("img");
        imglbl.classList.add("img2")
        imglbl.src = pregunta.op1img;
        label2.appendChild(imglbl);
    }
    if(pregunta.hasOwnProperty("op2img")){
        const imglbl = document.createElement("img");
        imglbl.classList.add("img2")
        imglbl.src = pregunta.op2img;
        label3.appendChild(imglbl);
    }
    if(pregunta.hasOwnProperty("op3img")){
        const imglbl = document.createElement("img");
        imglbl.classList.add("img2")
        imglbl.src = pregunta.op3img;
        label4.appendChild(imglbl);
    }
