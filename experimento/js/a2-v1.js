...
const bd_juego_O = [
    {
        id:96,
        pregunta:"Se tienen 5 bolsas de sal, cada una con 1.5 oz. Si se desea repartir su contenido entre 15 personas Â¿Cuántos gramos le corresponden a cada persona? Considera: 1 oz = 28.34g.",
        op0:"A) 28.34",
        op1:"B) 14.17",
        op2:"C) 56.68",
        op3:"D) 42.51",
    ...
    {
        id:99,
        pregunta:"La expresión (4a^2âˆ’9b^2)/(2aâˆ’3b) se simplifica como:",
        op0:"A) 1/(2a-3b)",
        op1:"B) 1/(2a+3b)",
        op2:"C) 2a - 3b",
        op3:"D) 2a + 3b",
    ...
    {
        id:102,
        pregunta:"Plantea matemáticamente el siguiente problema. Â¿Cuántas gallinas y borregos tenemos en un corral, si se sabe que hay 60 cabezas y 150 patas?",
    ...
    {
        id:106,
        pregunta:"Â¿Cuál es el dominio de la función f(x) = Ln (2x)?",
        op0:"A) (0, âˆž)",
        op1:"B) (0, 2)",
        op2:"C) (2, âˆž)",
        op3:"D) (2, âˆž)",
    ...
    {
        id:108,
        pregunta:"Â¿Cuál es la ecuación de la recta que pasa por los puntos (1,2) y (5,4)?",
        op0:"A) x + 2y - 5 = 0",
        op1:"B) 2x - y + 3 = 0",
        op2:"C) x - 2y + 3 = 0",
        op3:"D) 2x - y - 5 = 0",
    ...
    {
        id:110,
        pregunta:"Â¿Cuál es la ecuación de una parábola que tiene su vértice en V (1,0) y su foco en F (1,2)?",
        op0:"A) x^2 + 2x - 8y + 1 = 0",
        op1:"B) x^2 - 2x - 8y + 1 = 0",
        op2:"C) x^2 - 2x + 2y + 1 = 0",
        op3:"D) x^2 - 2x - 2y + 1 = 0",
    ...
    {
        id:112,
        pregunta:"Â¿Cuál es el centro de la hipérbola (xâˆ’2)^2/25 - (y + 7)^2/9 = 1?",
        op0:"A) C (5,7)",
        op1:"B) C (-5,7)",
        op2:"C) C (2, -7)",
        op3:"D) C (-2, -7)",
    ...
    {
        id:118,
        pregunta:"Â¿Cuál es la segunda derivada de 2e^x?",
        op0:"A) 4e^(2x)",
        op1:"B) 8e^x",
        op2:"C) 2e^x",
        op3:"D) 2e^(2x)",
...
const bd_juego_es = [
    ...
    },
    {
        ...
        op0:"Habí­an mucha gente en la plaza",
        op1:"Hubieron muchos que estaban inconformes",
        op2:"Habí­a mucha gente en la plaza",
        op3:"Habí­an muchos inconformes.",
        correcta:"2"
    },
    {
        id:60,
