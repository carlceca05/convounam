const bd_juego = [
    ...
    {
        id:18,
        pregunta:"Una persona pesa 96 kg. Al ingresar a una clí­nica reductora de peso, comienza a bajar 1/32 del peso inicial cada semana. Â¿Cuántos kg pesará al término de cada una de las primeras cuatro semanas del tratamiento?",
    ...
    {
        id:19,
        pregunta:"Para aprobar un examen de idiomas, un estudiante debe obtener un promedio mí­nimo de 8 y calificaciones no menores a 7 en cada uno de los parciales. Juan tiene las siguientes calificaciones en los primeros 3 parciales: 7.2, 8.5 y 7.9. Â¿Cuál es la mí­nima calificación que deberá obtener en el cuarto y último parcial para aprobar el curso?",
        op0:"8.1",
        op1:"8.2",
        op2:"8.4",
        op3:"8.9",
    ...
    {
        id:23,
        pregunta:"Calcula x para 5x + 3 â‰¤ 6x - 8",
        op0:"x â‰¤ 1",
        op1:"x â‰¥ 11",
        op2:"x â‰¥ 1",
        op3:"x â‰¤ -11",
    ...
    {
        id:24,
        pregunta:"Â¿Cuál es el número de conejos y gallinas en un corral si en su conjunto hacen un total de 61 cabezas y 196 patas?",
    ...
    {
        id:73,
        pregunta:"En la doctrina polí­tica del absolutismo el",
    ...
    {
        id:82,
        pregunta:"Paí­ses asiáticos que se independizaron a mediados del siglo XX.",
        op0:"India e Irán.",
        op1:"Timor y Angola.",
        op2:"Kenia e Irak.",
        op3:"Siria y Lí­bano.",
    ...
    {
        id:85,
        pregunta:"Fenómeno económico que se manifiesta en una serie de tendencias recientes del desarrollo capitalista que acelera la integración de las economí­as nacionales:",
        op0:"Neocapitalismo.",
        op1:"Socialismo.",
        op2:"Globalización.",
        op3:"Nacionalismo.",
    ...
    {
        id:99,
        pregunta:"La economí­a de mercado y las privatizaciones entre 1982 y 2000 son parte del",
