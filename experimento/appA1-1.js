...
const bd_juego = [
    ...
    {
        id:21,
        pregunta:"Si resuelves la desigualdad -2x + 6 â‰¥ 16 obtienes",
        op0:"x < 5",
        op1:"x â‰¥ 5",
        op2:"x â‰¤ -5",
        op3:"x = 5",
    ...
    },
    {
        ...
        op3:"Capacidad térmica especí­fica.",
        correcta:"3"
    },
    {
        id:53,
    ...
    {
        id:100,
        pregunta:"Cuando el usuario de la lengua muestra sensibilidad sociolingí¼í­stica para escoger el lenguaje apropiado a su comunicación, reconocemos una propiedad textual denominada",
        op0:"Lengua culta.",
...
function cargarPreguntas(){
    ...
    if (pregunta.hasOwnProperty("img")){
        ...
        const textA = document.createTextNode(" Consulta la lectura aquí")
        a.href = pregunta.a;
